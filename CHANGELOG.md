...
* Added `tmpsave` functionality (save the result of `dict_list` in temporary files)
* Now all saving related functions of DrWatson first `mkpath` of the path to save at and then save
# 0.2.1
